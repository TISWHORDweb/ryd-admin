                                            ...
                                            <Col>
                                                <div className="col-md-12 mb-3">
                                                    ...
                                                    <table style={{width: '100%'}}>
                                                        <tr>
                                                            <td><input value={packagesInput?.title||""} onChange={e=>setPackagesInput({...packagesInput, title: e.target.value})} placeholder={"Title"}/></td>
                                                            <td><input type={'number'} value={packagesInput?.cad||""} onChange={e=>setPackagesInput({...packagesInput, cad: e.target.value})} placeholder={"CAD"}/></td>
                                                            <td><input type={'number'} value={packagesInput?.ngn||""} onChange={e=>setPackagesInput({...packagesInput, ngn: e.target.value})} placeholder={"NGN"}/></td>
                                                            <td>
                                                                <Link
                                                                    className="text-success"
                                                                    to="#"
                                                    ...
                                                    <table style={{width: '100%'}}>
                                                        ...
                                                        {subPackages?.length>0 && subPackages?.map((s, i)=> <>
                                                            <tr>
                                                                ...
                                                                <td>{s.cad}</td>
                                                                <td>{s.ngn}</td>
                                                                <td><i className="bx bx-x font-size-18" style={{cursor: 'pointer'}} onClick={()=>{
                                                                    removeSubPackage(i)
                                                                }}></i></td>
                                                            </tr>
                                                        </>).reverse()||<p style={{width: '100%', textAlign: 'left', color: '#6e6e6e'}}>No Data Entries</p>}
                                                    </table>
                                                </div>
                                            </Col>
                                        </Row>
